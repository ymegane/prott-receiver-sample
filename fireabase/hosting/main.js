...
function Demo() {
  document.addEventListener('DOMContentLoaded', function() {
    ...
    this.shareUrlInput = document.getElementById('demo-url-input');
    this.sendButton = document.getElementById('demo-send-button');
    this.helloUserUrl = 'https://' + firebase.app().options.authDomain + '/authpreview';
    ...
    this.sendButton.addEventListener('click', this.startFunctionsRequest.bind(this));
...
Demo.prototype.startFunctionsRequest = function() {
  firebase.auth().currentUser.getToken().then(function(token) {
    ...
    var param = "?s=" + this.shareUrlInput.value;
    req.open('GET', this.helloUserUrl + param, true);
